...
def draw_clouds(canvas, scene_width, scene_height):
    ...
    cloud_height = scene_height / 2
    cloud_width = scene_width / 3
    cloud_left = scene_width -cloud_width / 2
    cloud_right = scene_height + cloud_height / 2
    cloud_top = scene_width + cloud_height

    draw_oval(canvas, cloud_left, cloud_top, cloud_right,\
      scene_width, outline= "white", width = 1, fill= ""  )
