...
def populate_main_window(frm_main):
    ...
    ent_age = nent.IntEntry(frm_main, 5, 100, width=5)
    ...
    ent_width = nent.IntEntry(frm_main, 0, 1000, width=5)

    lbl_length = tk.Label(frm_main, text="Length:")
    ent_length = nent.IntEntry(frm_main, 0, 1000, width=5)
    ...
    btn_clear.grid(row=5, column=0, padx=3, pady=3, columnspan=5, sticky="w")
    
    lbl_width.grid( row=3, column=0, padx=3, pady=3)
    ent_width.grid(row=3, column=1, padx=3, pady=3)
    lbl_length.grid(row=3, column=2, padx=3, pady=3)
    ent_length.grid(row=3, column=3, padx=3, pady=3)
    lbl_Area.grid(row=3, column=4, padx=(30,3), pady=3)
    lbl_area.grid(row=3, column=5, padx=3, pady=3)
